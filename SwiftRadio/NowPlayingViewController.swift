...
class NowPlayingViewController: UIViewController {
    ...
    func updateLabels(with statusMessage: String? = nil, animate: Bool = true) {
        ...
        songLabel.attributedText = NSMutableAttributedString(string: "text111")
                songLabel.text = "text222" // which should effect the attributedText property as well
                print(songLabel.attributedText) // arif expected "text222", got "text111"
